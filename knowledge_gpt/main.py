...
st.set_page_config(page_title="Plan de Gobierno Daniel Noboa", page_icon="📖", layout="wide")
st.header("📖 AI Plan de Gobierno Daniel Noboa")
...
with st.form(key="qa_form"):
    query = st.text_area("Preguntas al Plan de Gobierno")
